...
bool AnalysisManager::OpenFile(const std::string& file) {
  return G4AnalysisManager::Instance()->OpenFile(file);
}

bool AnalysisManager::OpenFile(const std::string& dir, const std::string& file) {
  return OpenFile(dir + "/" + file);
}

bool AnalysisManager::Write() {
  return G4AnalysisManager::Instance()->Write();
}

bool AnalysisManager::CloseFile() {
...
bool AnalysisManager::FillNTupleColumn(const std::string& name,
...
bool AnalysisManager::CreateH1(const std::string& name,
                               const std::string& title,
                               const G4int nbins,
                               const G4double xmin,
                               const G4double xmax) {
...
bool AnalysisManager::CreateH2(const std::string& name,
                               const std::string& title,
                               const G4int nxbins,
                               const G4double xmin,
                               const G4double xmax,
...
bool AnalysisManager::FillH1(const std::string& name,
                             const G4double value,
                             const G4double weight) {
  return G4AnalysisManager::Instance()->FillH1(_h1d[name], value, weight);
}

bool AnalysisManager::FillH2(const std::string& name,
...
bool AnalysisManager::ScaleH1(const std::string& name,
                              const G4double factor) {
  return G4AnalysisManager::Instance()->ScaleH1(_h1d[name], factor);
}

bool AnalysisManager::ScaleH2(const std::string& name,
                              const G4double factor) {
